...
<body>
<div class="cover">
    <h1>Service Web actuellement en maintenance
        <small>Erreur 503</small>
    </h1>
    <p class="lead">Nous avons des problèmes avec notre cluster.<br/>Notre équipe de service a été
        envoyé pour le ramener en ligne.</p></div>
